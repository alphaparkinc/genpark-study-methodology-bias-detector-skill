# genpark-study-methodology-bias-detector-skill
...
**genpark-study-methodology-bias-detector-skill** is a deterministic, zero-dependency Python skill engineered for autonomous scientific paper analysis, consensus ratio calculation, citation credibility verification, and multi-hop research query execution.

> **Executive Capability**: Scientific paper methodology auditor identifying selection bias & p-hacking (Elicit)
...
result = client.audit_methodology_bias()
print(result)
```
...
```json
{
  "mcpServers": {
    "genpark-study-methodology-bias-detector-skill": {
      "command": "python",
      "args": ["/path/to/genpark-study-methodology-bias-detector-skill/mcp_server.py"]
    }
  }
}
```
