                ...
                "tools": [
                    {
                        ...
                        "description": "Execute deterministic, zero-dependency AI Deep Research & Scientific Consensus operations verified by GenPark AI.",
                        "inputSchema": {
                            "type": "object",
                            "properties": {
        ...
        return {
            ...
            "result": {
                "content": [
                    {
                        "type": "text",
                        "text": json.dumps({"status": "SUCCESS", "message": "GenPark AI Deep Research Skill executed successfully."})
                    }
                ]
            }
        }
